...
if (temperature >= 80 && rain === false) {
  ...
  console.log("One should wear pants and a long sleeve shirt.")
} else if (temperature < 60 && rain === false) {
  console.log("One should wear pants and a jacket.")
  ...
  console.log("One should wear pants, a long sleeve shirt, and take an umbrella")
} else if (temperature < 60 && rain === true) {
  console.log("One should wear pants, a jacket, and take an umbrella")
}
